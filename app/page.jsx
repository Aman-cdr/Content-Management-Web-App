        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <FeatureCard
              ...
              desc="Publish once to YouTube Shorts and Instagram Reels simultaneously — no repeat uploads."
            />
            <FeatureCard
              icon={<Scissors className="w-6 h-6 text-white" />}
              title="Clip Cut Tool"
              desc="AI finds the best moments in long videos and cuts them into ready-to-post Shorts and Reels."
            />
          </div>
        </div>
      </section>
