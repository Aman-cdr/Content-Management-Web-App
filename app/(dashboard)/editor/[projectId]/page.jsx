    ...
    <div className="space-y-6 pb-24">
      <header className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          <button
            ...
            className="p-2.5 bg-white border border-[#E2E4E9] rounded-xl text-[#4B5264] hover:bg-[#F4F5F8] transition-all"
          >
            <ArrowLeft className="w-4 h-4" />
          </button>
          <div>
            <h2 className="text-2xl font-black text-[#0A0A0F]">{project.title || "Video Editor"}</h2>
        ...
        <div className="flex items-center gap-3">
          <span className={`px-3 py-1.5 rounded-lg text-[10px] font-black uppercase tracking-widest border ${status.tone}`}>
            {status.label}
          </span>
          <button
            onClick={() => setIsEditingDetails(true)}
            className="flex items-center gap-1.5 px-4 py-3 rounded-xl text-sm font-bold text-indigo-600 border border-indigo-100 hover:bg-indigo-50 transition-all"
          >
          ...
          <button
            ...
            className="flex items-center gap-2 px-6 py-3 bg-[#4F46E5] text-white rounded-xl text-sm font-black uppercase tracking-widest hover:bg-[#4338CA] transition-all shadow-lg shadow-indigo-600/20 disabled:opacity-50"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-4">
          <div className="relative">
            ...
            <button
              ...
              className="absolute bottom-4 left-4 p-3 bg-white/90 backdrop-blur-sm rounded-full text-[#0A0A0F] hover:bg-white transition-all shadow-lg"
            >
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white border border-[#E2E4E9] rounded-2xl p-4">
            ...
            <div className="flex items-center gap-2 mb-2">
              <button
                ...
                className={`flex-1 flex items-center justify-center gap-1.5 py-2 rounded-xl text-[11px] font-bold transition ${isReady ? "bg-red-500 hover:bg-red-600 text-white shadow-sm" : "bg-neutral-100 text-neutral-300 cursor-not-allowed"}`}
              >
              ...
              <button
                ...
                className={`flex-1 flex items-center justify-center gap-1.5 py-2 rounded-xl text-[11px] font-bold transition ${isReady ? "bg-gradient-to-r from-purple-500 to-pink-500 hover:brightness-110 text-white shadow-sm" : "bg-neutral-100 text-neutral-300 cursor-not-allowed"}`}
              >
            ...
            <button
              ...
              className={`w-full flex items-center justify-center gap-1.5 py-2 rounded-xl text-[11px] font-bold transition ${isReady ? "bg-gradient-to-r from-red-500 to-pink-500 hover:brightness-110 text-white shadow-sm" : "bg-neutral-100 text-neutral-300 cursor-not-allowed"}`}
            >
            ...
            {isReady && (
              <div className="flex items-center justify-between gap-2 pt-3 mt-3 border-t border-[#F4F5F8]">
                <div className="flex items-center gap-1.5 text-emerald-600 text-[11px] font-bold">
                  <CheckCircle2 className="w-3.5 h-3.5 shrink-0" /> Rendered
                </div>
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="flex items-center gap-1 px-2.5 py-1 rounded-lg text-[10px] font-black uppercase tracking-widest text-neutral-500 hover:bg-neutral-100 transition-all"
                >
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm" onClick={onClose}>
      ...
      >
        <div className="flex items-center justify-between px-6 py-5 border-b border-[#F4F5F8]">
          <h3 className="text-[15px] font-black text-[#111318]">Edit Details</h3>
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-4">
          <div>
            ...
            <input
              ...
              maxLength={100}
              className="w-full bg-[#F9FAFB] border border-[#E2E4E9] rounded-xl px-4 py-2.5 text-sm font-bold outline-none focus:border-indigo-400 transition"
            />
          ...
          <div>
            ...
            <textarea
              ...
              rows={4}
              className="w-full bg-[#F9FAFB] border border-[#E2E4E9] rounded-xl px-4 py-2.5 text-sm outline-none focus:border-indigo-400 transition resize-none"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full bg-[#F9FAFB] border border-[#E2E4E9] rounded-xl px-4 py-2.5 text-sm outline-none focus:border-indigo-400 transition"
            />
          </div>
        </div>
        ...
        <div className="px-6 py-4 border-t border-[#F4F5F8] flex items-center justify-end gap-3 bg-[#FAFBFC] rounded-b-3xl">
          ...
          <button
            onClick={handleSave}
            className="px-6 py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-bold transition shadow-md"
          >
            Save
          </button>
        </div>
