...
function StatCard({ stat, isLoading }) {
  ...
  const BG_MAP  = { Play: "bg-blue-50",   Users: "bg-purple-50", Video: "bg-pink-50",   Clock: "bg-emerald-50" };
  const CLR_MAP = { Play: "text-blue-600", Users: "text-purple-600", Video: "text-pink-600", Clock: "text-emerald-600" };
...
function NotConnectedBanner() {
  return (
    <div className="bg-amber-50 border border-amber-200 rounded-[20px] p-6 flex items-start gap-4">
      ...
      <div>
        <p className="font-bold text-amber-800 mb-1">YouTube not connected</p>
        <p className="text-sm text-amber-700">
          Connect your YouTube account in{" "}
...
export default function AnalyticsPage() {
  ...
  return (
    <div className="space-y-8 pb-12">
          ...
          <p className="text-neutral-500 text-[14px] mt-0.5">
            {data?.channelName ? (
              <span className="flex items-center gap-1.5">
                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="#ef4444"><path d="M23.5 6.2a3 3 0 0 0-2.1-2.1C19.5 3.5 12 3.5 12 3.5s-7.5 0-9.4.5A3 3 0 0 0 .5 6.2 31 31 0 0 0 0 12a31 31 0 0 0 .5 5.8 3 3 0 0 0 2.1 2.1c1.9.5 9.4.5 9.4.5s7.5 0 9.4-.5a3 3 0 0 0 2.1-2.1A31 31 0 0 0 24 12a31 31 0 0 0-.5-5.8zM9.75 15.5v-7l6.25 3.5-6.25 3.5z"/></svg>
      ...
      {/* Not connected */}
      {!isLoading && !data?.youtubeConnected && <NotConnectedBanner />}
