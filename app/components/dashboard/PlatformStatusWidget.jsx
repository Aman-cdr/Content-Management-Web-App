  ...
  return (
    <div className="bg-white border border-[#E5E7EB] rounded-[20px] p-5 shadow-[0_8px_30px_rgb(0,0,0,0.04)] flex flex-col h-full">
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-[13px] font-bold text-[#0A0A0F]">Platform Connections</h3>
      </div>
      ...
      <div className="flex-1 space-y-2.5">
        {PLATFORMS.map(({ key, label, icon: Icon, color }) => {
          const s = status[key];
          return (
            <div key={key} className="flex items-center justify-between gap-2 px-2.5 py-2 rounded-lg bg-[#F9FAFB]">
